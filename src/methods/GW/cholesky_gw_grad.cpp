...
namespace methods {
  ...
  namespace solvers {
    ...
    nda::array<ComplexType, 2> gw_gradient_t::evaluate(Cholesky_ERI auto && chol)
    {
      ...
      nda::array<ComplexType, 2> tmp_grad_2e = eval_grad_2e(chol);
    ...
    nda::array<ComplexType, 2> gw_gradient_t::eval_grad_2e(Cholesky_ERI auto && chol)
    {
    ...
    template Arr2D gw_gradient_t::evaluate(chol_reader_t&);

    template Arr2D gw_gradient_t::eval_grad_2e(chol_reader_t&);
